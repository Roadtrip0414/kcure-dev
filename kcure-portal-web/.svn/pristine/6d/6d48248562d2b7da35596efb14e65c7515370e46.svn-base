package kcure.portal.bbs.faq.web;
...
/**
  ...
  * @package_name        : kcure.portal.bbs.faq.web
  * @FileName : FaqController.java
  * @since : 2023. 3. 13.
  * @version 1.0
  * @author : hjjeon
  * @프로그램 설명 :	FAQ Controller
  * @see
  *
  * <pre>
  ...
  */
@Controller
@RequestMapping("/portal/bbs/faq")
public class FaqController {
	//게시판Id
	public static String BBS_ID = "BBSMSTR_000000000002";
    ...
    public String viewFaq(@ModelAttribute("searchVO") NtcVO ntcVO, ModelMap model) throws Exception {
        ...
        return "kcure/portal/bbs/faq/ViewFaq";
    }
}
