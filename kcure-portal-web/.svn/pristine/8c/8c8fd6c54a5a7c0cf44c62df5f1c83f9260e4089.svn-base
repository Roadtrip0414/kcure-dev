package kcure.portal.bbs.ntc.web;
...
/**
  ...
  * @package_name        : kcure.portal.bbs.ntc.web
  * @FileName : NtcController.java
  * @since : 2023. 3. 13.
  * @version 1.0
  * @author : hjjeon
  ...
  */
@Controller
@RequestMapping("/portal/bbs/ntc")
public class NtcController {
	//게시판Id
	public static String BBS_ID = "BBSMSTR_000000000001";
    ...
    public String viewNtc(@PathVariable String viewPageNm, @ModelAttribute("searchVO") NtcVO ntcVO, ModelMap model) throws Exception {
        ...
        return "kcure/portal/bbs/ntc/"+viewNm;
    }
