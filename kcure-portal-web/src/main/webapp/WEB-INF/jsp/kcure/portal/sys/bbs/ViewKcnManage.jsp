...
var gridColumns = [
{
	...
	renderer: {
	      ...
	      callback: function (grid, cell, w, h) {
	    	var src = "";
	    	var fileStreCours = grid.getValue(cell.item.index, "fileStreCours");
            var streFileNm = grid.getValue(cell.item.index, "streFileNm");
            if(streFileNm != null && streFileNm != ""){
            	src = fileStreCours + streFileNm;
            }else{
            	src = "/images/thumb_s.png";
            }
	        var str = "";
	        str = "<img src='"+src+"' alt='썸네일' onerror='this.src=`/images/thumb_s.png`' style='width: 120px;'/>";
	        return str;
			},
	},
	width: "150"
	...
	$(document).ready(function() {
		...
		gridView.onCellClicked = function (grid, clickData) {
			if(clickData.cellType != "header"){
			    ...
			    $("#srchForm").attr("action", "/portal/sys/bbs/kcn/detailViewKcnManage.do").submit();
			}
		}
		...
		searchDate = function() {
			RG.doQuery({
						action : "/portal/sys/bbs/kcn/selectBbsList.do",
						form : "srchForm",
						dataProviderPram : gridDataProvider,
						gridViewPram : gridView,
		...
		$("#registBtn").click(function() {
			$("#srchForm").attr("action", "/portal/sys/bbs/kcn/insertKcnManage.do").submit();
		});
