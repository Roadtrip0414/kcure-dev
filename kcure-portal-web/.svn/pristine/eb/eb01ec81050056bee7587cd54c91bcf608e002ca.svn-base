package kcure.portal.dvz.clc.gst.web;
 ...
 * @package_name        : kcure.portal.dvz.clc.gst.web
 * @FileName : DvzClcGstController.java
 * @since : 2023. 02. 01. 
 * @version 1.0
 * @author : kyh
 * @프로그램 설명 :	데이터시각화 임상라이브러리 위암에 대한 controller 클래스를 정의한다.
 * @see
 *
 * <pre>
 ...
 */
@Controller
@RequestMapping("/portal/dvz/clc/gst/")
public class DvzClcGstController {
	...
	/**
	 * @Method Name : viewDvzClcGst
	 * @작성일 : 2023. 02. 01.
	 * @작성자 : kyh
	 * @Method 설명 :  	위암 화면을 호출한다.
	 * @param : model
	 * @return :
	 */
    @RequestMapping(value="viewDvzClcGst.do")
    public String viewDvzClcGst(@RequestParam HashMap<String, Object> commandMap, ModelMap model) throws Exception {
    	...
    	if ("".equals(topVslzMenuId)) commandMap.put("topVslzMenuId", "GST");		//위암
    	...
    	return "kcure/portal/dvz/clc/ViewDvzClcGst";
    }
}
