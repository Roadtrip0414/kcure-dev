	...
	$(document).ready(function() {
		...
		gridView.onCellClicked = function (grid, clickData) {
			if(clickData.cellType != "header"){
		    	...
		    	$("#srchForm").attr("action", "/portal/bbs/prt/ntc/detailViewPrtNtc.do").submit();
			}
		}
		...
		searchDate = function() {
			RG.doQuery({
						action : "/portal/bbs/prt/ntc/selectNtcList.do",
						form : "srchForm",
						dataProviderPram : gridDataProvider,
						gridViewPram : gridView,
...
<div class="wrap">
	...
	<div class="sub_nav_wrap">
		...
		<a href="/portal/bbs/prt/ntc/viewPrtNtc.do" class="on">공지사항</a>
	...
	<div class="notice_list_wrap">
		<div class="con">
			<div class="sub_pag_title">
				<p>공지사항</p>
				<span>K-CURE 포털을 이용하시는 참여기관 이용자들에게 알려드리는 공지사항입니다.</span>
			</div>
