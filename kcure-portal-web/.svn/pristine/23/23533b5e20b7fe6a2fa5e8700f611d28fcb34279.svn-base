...
public interface OAuthConfig {
	...
	static final String NAVER_SERVICE_CODE = "03";
	
	static final String KAKAO_SERVICE_NAME = "kakao";
	static final String KAKAO_SERVICE_CODE = "02";
	
	static final String ONEPASS_SERVICE_NAME = "onepass";
	static final String ONEPASS_SERVICE_CODE = "04";
}
