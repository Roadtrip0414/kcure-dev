package kcure.portal.bbs.prt.qna.web;
...
/**
  ...
  * @package_name        : kcure.portal.bbs.prt.qna.web
  * @FileName : PrtQnaController.java
  * @since : 2023. 3. 14.
  * @version 1.0
  * @author : hjjeon
  * @프로그램 설명 :	(기관)QNA Controller
  * @see
  *
  * <pre>
  ...
  */
@Controller
@RequestMapping("/portal/bbs/prt/qna")
public class PrtQnaController {
    ...
    public String viewPrtQna(@PathVariable String viewPageNm, @ModelAttribute("searchVO") QnaQstnVO qnaQstnVO, ModelMap model) throws Exception {
    	...
    	if(user != null) {
	    	model.addAttribute("prtiId", user.getPrtiId());
	    	model.addAttribute("prtiNm", user.getPrtiNm());
        ...
        return "kcure/portal/bbs/prt/qna/"+viewNm;
    }
    ...
    public ModelAndView selectQnaList(@ModelAttribute("searchVO") QnaQstnVO qnaQstnVO, ModelMap model) throws Exception {
    	...
    	qnaQstnVO.setInstGnrSpcd("02");	//02-기관
