...
/**
  ...
  * @package_name        : kcure.portal.sys.log.lgm.service
  * @FileName : UserActionLog.java
  * @since : 2023. 1. 18. 
  * @version 1.0
  * @author : shpark
  * @프로그램 설명 :		사용자 action (시스템)를 위한 VO 클래스를 정의한다
  * @see
  *
  * <pre>
...
public class UserActionLog implements Serializable{
	...
	private static final long serialVersionUID = -7881227714648027411L;
	/**
	 * 에러횟수
	 */
	...
	private String menuUriAddr = "";




	public String getMenuUriAddr() {
		return menuUriAddr;
	}
	public void setMenuUriAddr(String menuUriAddr) {
		this.menuUriAddr = menuUriAddr;
	}
	/**
	 * @return the errorCo
	 */
