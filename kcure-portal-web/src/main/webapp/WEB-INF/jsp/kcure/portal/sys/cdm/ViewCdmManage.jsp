...
$(document).ready(function() {
	...
	gridView.onCellClicked = function (grid, clickData) {
		if(clickData.cellType != "header"){
			//현재 상태가 신규일 경우.
			var provider = grid._dataProvider;
			var rowState =  provider.getRowState(clickData.dataRow);
			
			var grpCd = grid.getValue(clickData.dataRow, 'grpCd');
			var subGrpCd = gridView2.getValue(0, 'grpCd');
			//상세Grp 코드와 다를경우 검색 
			if(grpCd != subGrpCd){
				if('created'== rowState){
	...
	$("#srchBtn").click(function() {
	 ...
	 searchGrpCode = function() {
		RG.doQuery({
					action : "/portal/sys/cdm/mng/selectGrpCdList.do",
					form : "srchForm",
					dataProviderPram : gridDataProvider,
					gridViewPram : gridView,
	...
	$("#saveBtn").click(function() {
		...
		if(errorCells != null && errorCells.length > 0){
			...
			RG.doSave({
				action : "/portal/sys/cdm/mng/saveCdmCdData.do",
	...
	gridView2.displayOptions.syncGridHeight = "always";3
	...
	searchGrpCode2 = function(grpCd) {
		RG.doQuery({
					action : "/portal/sys/cdm/mng/selectGrpDetailList.do",
					params : {"grpCd":grpCd},
					dataProviderPram : gridDataProvider2,
					gridViewPram : gridView2,
					form : "srchForm2",
	...
	$("#saveBtn2").click(function() {
		...
		if(errorCells != null && errorCells.length > 0){
			...
			RG.doSave({
				action : "/portal/sys/cdm/mng/saveCdmDetailCdData.do" ,
