			...
			<div class="n_gap_box">
				<div class="n_section">
					<div class="guide_line">
						<div class="con_title">
							<h3>임상 데이터 신청 절차 안내</h3>
							<p>임상 데이터는 다음과 같은 절차를 통해 제공되며 <span>“나의연구”</span>에서 진행 현황을 확인하실 수 있습니다.</p>
						</div>
				...
				<div class="n_section">
					...
					<img src="/images/pcd_guide_01.svg" width="1225" alt="임상 데이터 세부 신청 잘차 안내 이미지">
				</div>
				<div class="n_section">
					<div class="title">
						<h3>K-CURE 데이터 신청</h3>
					...
					<div class="sec_white_box">
						<div class="list_txt">
							<ul>
								<li>임상라이브러리를 활용하기 위한 연구를 신청합니다.</li>
...
<form id="applyFrm" name="applyFrm" method="post">
	<input type="hidden" name="dataTpcd" value="01"/>
</form>
