...
<!-- 공통 처리 스크립트   -->
<script type="text/javascript" src="/js/global.ajax.js"></script>
<script type="text/javascript" src="/js/global.form.js"></script>
<script type="text/javascript">

	function fn_egov_downFile(atchFileId, fileSn){
		window.open("<c:url value='/cmm/fms/nonCheck/FileDown.do?atchFileId="+atchFileId+"&fileSn="+fileSn+"&crrent_url_info="+window.location.href+"'/>");
	}
