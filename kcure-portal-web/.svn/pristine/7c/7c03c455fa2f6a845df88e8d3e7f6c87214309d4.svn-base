package kcure.portal.sys.bbs.ntc.web;
...
@RequestMapping("/portal/sys/bbs/ntc")
public class BbsNtcController {
	//게시판Id
	public static String BBS_ID01 = "BBSMSTR_000000000001";
	public static String BBS_ID04 = "BBSMSTR_000000000004";
    ...
    public ModelAndView selectBbsList(@ModelAttribute("searchVO") BbsVO bbsVO, ModelMap model) throws Exception {
    	...
    	bbsIdList.add(BBS_ID01);
    	bbsIdList.add(BBS_ID04);
        ...
        model.addAttribute(GridVar.gridView, bbsNtcService.selectNtcList(bbsVO));
    ...
    public ModelAndView saveBbs(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BbsVO bbsVO, ModelMap model) throws Exception {
    	...
    	ModelAndView modelAndView = new ModelAndView("jsonView", model);
    	return modelAndView;
    	//return "redirect:/portal/sys/bbs/ntc/viewNtcManage.do";
    }
