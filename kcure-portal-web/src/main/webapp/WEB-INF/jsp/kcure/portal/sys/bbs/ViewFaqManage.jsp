...
var gridColumns = [
{
	...
	renderer: {
	    ...
	    callback: function (grid, cell, w, h) {
	  		var str = "일반";
			if(cell.value == "BBSMSTR_000000000005"){
				str = "기관";
			}
	     	return str;
		},
	...
	$(document).ready(function() {
		...
		gridView.onCellClicked = function (grid, clickData) {
			if(clickData.cellType != "header"){
			    ...
			    $("#srchForm").attr("action", "/portal/sys/bbs/faq/detailViewFaqManage.do").submit();
			}
		}
		...
		searchDate = function() {
			RG.doQuery({
						action : "/portal/sys/bbs/faq/selectBbsList.do",
						form : "srchForm",
						dataProviderPram : gridDataProvider,
						gridViewPram : gridView,
		...
		$("#registBtn").click(function() {
			$("#srchForm").attr("action", "/portal/sys/bbs/faq/insertFaqManage.do").submit();
		});
		...
		<div class="section">
			...
			<form id="srchForm" name="srchForm" method="post">
				...
				<div class="search_wrap">
					<div class="item">
						<h4>카테고리</h4>
						<kcure:select id="searchKeyword" name="searchKeyword" grpCd="NTT_SE_CODE" defaultText="전체"/>
					</div>
					<div class="item">
						<h4>검색대상</h4>
						<div class="sel_int">
