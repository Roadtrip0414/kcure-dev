...
},
{
	...
	type: "data",
	styleName: "ud-column-cebnter",
	readOnly: true,
	renderer: {
	    type: "html",
	    inputFocusable: true,
	    callback: function (grid, cell, w, h) {
	    	var userMbphNo = grid.getValue(cell.index.dataRow, 'userMbphNo');
	...
	$(document).ready(function() {
		...
		gridView.onCellClicked = function (grid, clickData) {
			if(clickData.cellType != "header"){
				var userId = grid.getValue(clickData.dataRow, 'userId');
				searchDate2(userId);
				searchDate3(userId);
			}
		}
		...
		searchDate = function() {
			RG.doQuery({
						action : "/portal/sys/usr/stt/selectUsrList.do",
						form : "srchForm",
						dataProviderPram : gridDataProvider,
						gridViewPram : gridView,
		...
		<div class="area_wrap">
			<div class="section">
				...
				<form id="srchForm" name="srchForm" method="post">
					<input type="hidden" name="userStcd" value="03"/>
				...
				<div class="btn_info">
					...
					<div class="s_btn">
						<a href="javascript:void(0)" id="pwInitBtn">비밀번호 초기화</a>
