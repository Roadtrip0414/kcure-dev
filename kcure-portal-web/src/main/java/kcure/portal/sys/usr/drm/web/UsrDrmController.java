package kcure.portal.sys.usr.drm.web;
...
/**
  ...
  * @package_name        : kcure.portal.sys.usr.drm.web
  * @FileName : UsrController.java
  * @since : 2023. 1. 31.
  * @version 1.0
  * @author : hjjeon
  * @프로그램 설명 :	사용자 휴면계정 현황 Controller
  * @see
  *
  * <pre>
...
@RequestMapping("/portal/sys/usr/drm/")
public class UsrDrmController {
    ...
    /**
      * @Method Name : viewUsrDrmtStatus
      * @작성일 : 2023. 1. 31.
      * @작성자 : hjjeon
      * @Method 설명 : 사용자 휴면 계정 현황 화면 조회
      *  <p>
      *  </p>
      * @param :
      * @return : String
      */
    @RequestMapping(value="/viewUsrDrmtStatus.do")
    public String viewUsrDrmtStatus(ModelMap model) throws Exception {
        ...
        return "kcure/portal/sys/usr/ViewUsrDrmtStatus";
    }
    /**
      * @Method Name : selectUsrDrmList
      * @작성일 : 2023. 1. 31.
      * @작성자 : hjjeon
      * @Method 설명 : 사용자 휴면계정 현황 목록 조회
      *  <p>
      *  </p>
      * @param : usrVO UsrVO
      * @return : ModelAndView
      */
    @RequestMapping(value="/selectUsrDrmList.do")
    public ModelAndView selectUsrDrmList(@ModelAttribute("searchVO") UsrVO usrVO, ModelMap model) throws Exception {
