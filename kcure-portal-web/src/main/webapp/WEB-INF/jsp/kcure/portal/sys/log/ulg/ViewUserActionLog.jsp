<%
/* =================================================================
 * @FileName  : ViewUserActionLog.jsp
 * @date: 2023. 1. 18.
 * @author : shpark
 * @설명 : 사용자 Action 로그 관리
 * =================================================================
...
<script src="/js/kcure/portal/sys/log/ulg/userActionLogInfo.js" ></script>
...
$(document).ready(
		function() {
			...
			var searchDate = function() {
				...
				RG.doQuery({
							action : "/portal/sys/log/ulg/SelectUserActionLogList.do",
							dataProviderPram : gridDataProvider,
							gridViewPram : gridView,
...
<!-- 						<a href="javascript:void(0)">초기화</a> -->
				...
				<form id="SysLogForm" name="SysLogForm" method="post">
					<div class="search_wrap">
							...
							<div class="item">
								<h4>처리구분</h4>
								<kcure:select id="searchType" name="searchType" grpCd="USER_LOG_TPCD" defaultText="선택"/>
							</div>
							<div class="item">
								<h4>사용자 ID</h4>
								<input type="text" name="searchId" id="searchId" title="검색아이디">
							</div>
					</div>
				</form>
				<div class="btn_info">
